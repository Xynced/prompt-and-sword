...
export function warlord(): UnitSpec {
  return {
    ...
    side: 'foe',
    maxHp: 52,
    // atk 8, не 9: по симу фазы 5 при 9 босс не решается даже контр-билдами
    // на полном hp (портфель из 8 билдов — 61% сидов); при 8 — наив ~22%,
    // контр-билды ~60%, решаемость ~88%
    atk: 8,
    range: 1,
    speed: 6,
    move: 3,
