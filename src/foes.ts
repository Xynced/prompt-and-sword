...
export function archer(n: number): UnitSpec {
  return {
    ...
    side: 'foe',
    maxHp: 28,
    defenses: { ac: 14, fort: 6, ref: 10, will: 6 },
...
export function warChief(): UnitSpec {
  return {
    ...
    weapons: [{ name: 'топор вождя', dmg: 7, range: 1, dmgType: 'slashing', atkBonus: 10 }],
    speed: 5,
    move: 2,
    tags: ['leader'],
    lenses: ['fanatic'],
...
export function berserker(n: number): UnitSpec {
  return {
    ...
    weapons: [{ name: 'шипастый цеп', dmg: 8, range: 1, dmgType: 'bludgeoning', atkBonus: 10 }],
    speed: 6,
    move: 3,
    lenses: ['fanatic'],
    rules: [
...
export function rat(n: number): UnitSpec {
  return {
    ...
    side: 'foe',
    maxHp: 10,
    defenses: { ac: 14, fort: 5, ref: 10, will: 3 },
...
export function slinger(n: number): UnitSpec {
  return {
    ...
    side: 'foe',
    maxHp: 16,
    defenses: { ac: 14, fort: 5, ref: 10, will: 5 },
    weapons: [
...
export function soldier(n: number, buddyId: string): UnitSpec {
  return {
    ...
    side: 'foe',
    maxHp: 42,
    defenses: { ac: 18, fort: 9, ref: 5, will: 7, resist: { slashing: 2 } },
    weapons: [
...
export function sergeant(): UnitSpec {
  return {
    ...
    side: 'foe',
    maxHp: 52,
    defenses: { ac: 18, fort: 10, ref: 5, will: 8, resist: { slashing: 2 } },
    weapons: [{ name: 'палаш', dmg: 7, range: 1, dmgType: 'slashing', atkBonus: 10 }],
    speed: 5,
    move: 2,
    tags: ['leader'],
    lenses: ['plain'],
...
export function wolf(n: number): UnitSpec {
  return {
    ...
    side: 'foe',
    maxHp: 32,
    defenses: { ac: 15, fort: 8, ref: 10, will: 5 },
...
export function ogre(): UnitSpec {
  return {
    ...
    weapons: [{ name: 'дубина-бревно', dmg: 10, range: 1, dmgType: 'bludgeoning', atkBonus: 11 }],
    speed: 2,
    move: 1,
    lenses: ['plain'],
    rules: [
...
export function troll(): UnitSpec {
  return {
    ...
    weapons: [{ name: 'когтистые лапы', dmg: 8, range: 1, dmgType: 'slashing', atkBonus: 11 }],
    speed: 4,
    move: 2,
    lenses: ['fanatic'],
...
export function duelist(): UnitSpec {
  return {
    ...
    side: 'foe',
    maxHp: 76,
    defenses: { ac: 19, fort: 9, ref: 11, will: 8 },
    weapons: [
      { name: 'клеймор', dmg: 9, range: 1, dmgType: 'slashing', atkBonus: 12, affinity: { attack: 1, weakAttack: -1 } },
      { name: 'чекан', dmg: 7, range: 1, dmgType: 'bludgeoning', atkBonus: 12, affinity: { weakAttack: 1 } },
    ],
    speed: 5,
    move: 2,
    lenses: ['duelist'],
...
export function warlord(): UnitSpec {
  return {
    ...
    maxHp: 132,
    defenses: { ac: 19, fort: 12, ref: 8, will: 10 },
