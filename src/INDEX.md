...
| [ui/main.ts](ui/main.ts) | Весь веб-UI одним файлом (чистый DOM + Vite): карта, бой, конструктор (вложенные чипсы условий до трёх уровней со связкой «и»/«или»), спарринг, журнал; панель задачи боя на узле и в бою, фикс-расстановка сценария; тест-кнопки «debug» и «свободный режим» (весь словарь разом) |
