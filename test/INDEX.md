...
| [deploy.test.ts](deploy.test.ts) | Расстановка: валидация setDeploy, дефолт слотов, детерминизм с ручной расстановкой, спарринг её фиксирует, превью спавнов совпадает с боем |
