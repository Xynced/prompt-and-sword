...
| [aoe.test.ts](aoe.test.ts) | Залп (АОЕ): кандидаты вокруг врагов в дальности и LoS, гейт правилом и оружием; окупается от двух накрытых, центр обходит своих; фиксированный урон, friendly fire; шаман в бою |
